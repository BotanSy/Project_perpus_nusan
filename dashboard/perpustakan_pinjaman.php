                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-striped table-bordered">
                                <div class="mb-3">
                                    <a class="btn btn-success" href="../assets/export_excel2.php">Export ke Excel</a>
                                </div>
                                <thead>
                                    <tr>
                                        <th>KD Pinjam</th>
                                ...
                                <tbody id="data-body">
                                    ...
                                    while ($user_data = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td><center>
                                                <a href='../assets/edit2.php?kd_pinjam=" . (isset($user_data['kd_pinjam']) ? $user_data['kd_pinjam'] : '') . "' class='btn btn-primary'>PERPANJANG</a> | 
