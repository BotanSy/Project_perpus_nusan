                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <a class="btn btn-primary mr-2" href="add.php">Tambah Buku</a>
                                    <a class="btn btn-success" href="../assets/export_excel.php">Export ke Excel</a>
                                </div>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        while ($user_data = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td><center>
                                                <a href='../assets/edit.php?id_buku={$user_data['id_buku']}' class='btn btn-primary'>EDIT</a> | 
                                                <a href='../assets/delete.php?id_buku={$user_data['id_buku']}' class='btn btn-danger'>DELETE</a>
                                            </center></td>";
                                            echo "</tr>";
                                        }
                                        ?>
