...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO anggota (id_anggota, email, nama_lengkap, alamat, level) VALUES ('$id_anggota', '$email', '$nama_lengkap', '$alamat', '$level')");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="add_anggota.php" method="post" name="form">
