            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="add_pinjaman_user.php">Pinjam Buku</a>
                        <a class="nav-link" href="add_anggota_user.php">Tambah Anggota</a>
                    <!-- databuku user BLM DIBUAT -->
                        <div class="sb-sidenav-menu-heading">Menu Data</div>
                        <a class="nav-link" href="data_buku_user.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Data Buku
                        </a>
                        <!-- pinjaman user BLM DIBUAT -->
                        <a class="nav-link" href="data_peminjaman_user.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Data Peminjaman
                        </a>
                        <!-- anggota BLM DIBUAT -->
                        <a class="nav-link" href="data_anggota_user.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Data Anggota
                        </a>
                    </div>
