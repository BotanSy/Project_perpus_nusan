...
// Execute query
$result = mysqli_query($mysqli, "SELECT id_anggota, email, nama_lengkap, alamat, level FROM anggota ORDER BY id_anggota DESC");
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Anggota
                        </div>
                        <div class="card-body">
                        <div class="mb-3">
                            <a class="btn btn-primary" href="add_anggota.php">Tambah Member</a>
                            <a class="btn btn-success" href="../assets/export_excel3.php">Export ke Excel</a>
                            </div>
                            <table id="datatablesSimple" class="table table-striped table-bordered">
                                ...
                                <?php
                                    while ($user_data = mysqli_fetch_array($result)) {
                                        echo "<tr>";
                                        echo "<td class='text-center'>{$user_data['id_anggota']}</td>";
                                        echo "<td class='text-center'>{$user_data['email']}</td>";
                                        echo "<td class='text-center'>{$user_data['nama_lengkap']}</td>";
                                        echo "<td class='text-center'>{$user_data['alamat']}</td>";
                                        echo "<td class='text-center'>{$user_data['level']}</td>";
                                        echo "</tr>";
                                    }
                                ?>
                                </tbody>
